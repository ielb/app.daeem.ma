        ...
        <div class="col">
            <div class="card card-profile bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id" id="cid" value="{{$zone->id}}">
                    <div class="form-group">
                         <label for="name" class="form-control-label">Name</label>
                         <input class="form-control " name="name"   type="text" id="name" value="{{$zone->name}}">
                      </div>
                    ...
                    <div class="my-2">
                        <button type="button" id="update_name" class="btn btn-success btn-sm btn-block">{{ __("Update Name")}}</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $("#clear_area").on("click",function() {
            ...
            $.ajax({
                type:'POST',
                url: '/update/radius/zone/'+$('#cid').val(),
                dataType: 'json',
                data: {
