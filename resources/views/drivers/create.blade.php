                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <span>
                                        ...
                                        <div class="form-group{{ $errors->has('worker_role') ? ' has-danger' : '' }}">

                                            <label class="form-control-label">{{ __('Role') }}</label>

                                            <div class="custom-control custom-radio mb-3">

                                                <input name="worker_role" class="custom-control-input" id="driver" value="driver" type="radio">
                                            ...
                                            <div class="custom-control custom-radio mb-3">
                                                ...
                                                <input name="worker_role" class="custom-control-input" id="collector" value="collector" type="radio">
