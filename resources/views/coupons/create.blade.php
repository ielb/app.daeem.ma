...
<div class="card">
  ...
  <div class="card-body bg-secondary">
    <form class="needs-validation" action="{{ route('coupons.add') }}" method="POST">
      @csrf
      <div class="form-row">
      ...
      <div class="form-row">
        <div class="col-md-6 mb-3">
          ...
          <input type="datetime-local" class="form-control" id="active_from" name="active_from" placeholder="" required>
        </div>
        <div class="col-md-6 mb-3">
          <label class="form-control-label" for="active_to">Active To</label>
          <input type="datetime-local" class="form-control" id="active_to" name="active_to" placeholder="State" required>
        </div>
      </div>
      <div class="form-row">
        <div class="col-md-6 mb-3">
          <label class="form-control-label" for="discount_price">Discount Price</label>
          <input type="number" step="any" class="form-control" id="discount_price" name="discount_price" placeholder="Price" aria-describedby="" required>
        </div>
        
        <div class="col-md-6 mb-3">
          <label class="form-control-label" for="limit_uses">Limit To Num Uses</label>
          <input type="number" class="form-control" id="limit_uses" name="limit_uses" placeholder="Limit" required>
        </div>
      </div>
      <div class="form-row">
